...
namespace BulkyBookWeb.Controllers
{
    public class CategoriesTempController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DisplayOrder,CreadtedDateTime")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DisplayOrder,CreadtedDateTime")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
